const nameGirl = 'Vợ yêu';
const giftUrl = 'http://nodemy.vn';
const eventName = 'Chúc Mừng 20-10';
const titleCard = 'Tặng Vợ yêu';
const contentCard = 'Chúc vợ 20/10 tràn ngập niềm vui và những nụ cười. Mong điều đẹp nhất sẽ đến với em trong hôm nay và cả những ngày sau. Cám ơn mẹ con em đã đến với anh. Yêu em //^}{^)';
